	    ...
	    <div class="course" v-if='active'>
	      <div class="main">
	        <div class="introduction">
	          <div class="desc" v-if="courseInfo.bizCourseDetail">
	            {{courseInfo.bizCourseDetail}}
	          </div>
...
onBeforeMount(()=>{
    getDetail({
        ...
        courseInfo.courseLevel=data.courseLevel
        courseInfo.totalHour=data.totalHour
        courseInfo.purchaseCnt=data.purchaseCnt
        courseInfo.purchaseCounter=data.purchaseCounter
        courseInfo.bizCourseDetail=data.bizCourseDetail.description
        courseChapters.value=data.bizCourseChapters
        attachments.value = data.bizCourseAttachments;
    })
})
