                                    ...
                                    >
									    ...
									    <el-form-item class="login-Verification" prop="captcha">
									       <el-input v-model="ruleFormPhone.captcha" placeholder="请输入您的验证码"/>
									        <el-button class="btn btn-primary sendcaptcha" type="primary" @click="sendCode">{{captcha}}</el-button>
									    </el-form-item>
	                                    <div class="login-submit">
	                                    	<el-button class="btn btn-primary sendcaptcha" type="primary" @click="phoneBtn(ruleFormRefPhone)">登录</el-button>
	                                    </div>
	                                    <div class="login-text">
	                                        登录即同意相关服务条款和隐私政策 <a>《小鹿线用户服务协议》</a><a>《小鹿线隐私政策》</a> 若您没有账号，系统将为您自动创建账号并登录。
	                                    </div>
